      ...
      interaction.guild.channels.create(`ticket-${interaction.user.username}`, {
        ...
        const row = new client.discord.MessageActionRow()
          .addComponents(
            ...
            .addOptions([{
                label: 'Problème IG',
                value: 'pour un **Problème IG**',
                emoji: '🎮',
              },
              {
                label: 'Problème Serveur',
                value: 'pour un **Problème Serveur**',
                emoji: '❓',
              },
              {
                label: 'Autres',
        ...
        collector.on('collect', i => {
          if (i.user.id === interaction.user.id) {
            ...
            if (i.values[0] == 'Problème IG') {
              c.edit({
                parent: client.config.parentProblèmeIG 
              });
            };
            if (i.values[0] == 'Problème Serveur') {
              c.edit({
                parent: client.config.parentProblèmeServeur
              });
            };
